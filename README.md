...
- Create Categories.
- Create budgets into special categories.
...
```
  git clone https://github.com/Mhamad-Raad/rails-capstone.git
...
Feel free to check the [issues page](https://github.com/Mhamad-Raad/rails-capstone/issues).
...
- Special thanks for the Original design idea by [Gregoire Vella](https://www.behance.net/gregoirevella) on Behance.
